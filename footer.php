<section class="outer-container-footer">
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-lg-4">
        <div class="section-title-black">
          <img class="img-logo-footer"  style="margin-bottom:20px;margin-top:20px;" src="/public/logo/logo-black-1.png"/>
        </div>
      </div>
      <div id="footer">
        <div id="footerback"><a target="_blank" href="https://api.whatsapp.com/send?phone=6282267761122&text=Hello%20admin%20MP,%20Saya%20ingin%20buat%20baju%20nih%20sebanyak%20:%20"><div class="ic-item-float system-font"><img class="ic-item-float" src="/public/icon/1.png"/></div></a></div>
        <div id="footernext"><a target="_blank" href="https://www.instagram.com/masterpiece_id/"><div class="ic-item-float system-font"><img class="ic-item-float" src="/public/icon/2.png"/></div></a></div>
      </div>
      ...
      <div class="col-md-12 col-lg-5">
        ...
        <div class="section-title-black bold system-font">Bantuan</div>
        <div class="section-content-black system-font"><img class="ic-tel" src="/public/footer/5.png"/><a class="link-footer" href="tel:021-54313875">021-54313875</a> / <a class="link-footer" href="tel:061-4515953">061-4515953</a></div>
        <div class="section-content-black system-font"><img class="ic-tel" src="/public/footer/7.svg"/><a class="link-footer" href="tel:+62-822-6776-1122">0822 6776 1122</a></div>
        <div class="section-content-black system-font"><img class="ic-tel" src="/public/footer/6.png"/><a class="link-footer" href="mailto:masterpiececlothing.mp@gmail.com" style="font-size: 14px">masterpiececlothing.mp@gmail.com</a></div>
      </div>
    </div>
    <div class="system-font" style="font-size:10px;font-weight:thin;text-align:center;margin-top: 6rem; margin-bottom: 2rem;">Copyright © 2021 Masterpiece Clothing. All Rights Reserved.</div>
  </div>
</section>